...
public class WaveLoadingView extends View {
    ...
    private static final int DEFAULT_WAVE_COLOR = Color.parseColor("#FF9800");
    private static final int DEFAULT_TITLE_COLOR = Color.parseColor("#FF9800");
    private static final float DEFAULT_BORDER_WIDTH = 7;
